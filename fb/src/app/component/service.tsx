...
export const Service = (): React.ReactElement => {
    return (
        <div id="service" className="flex flex-col items-center p-10">
            ...
            <div className="flex overflow-x-auto break-words px-2 justify-center text-center text-xs text-white">
                <div className="inline-block max-w-40 px-2">
                    <Link href="/scan" className="  bg-red-500 rounded-full p-1 text-xl"><FontAwesomeIcon icon={faCamera} /></Link>
                ...
                <div className="inline-block max-w-40 px-2">
                    <Link href="/search" className=" bg-red-500 rounded-full p-1 text-xl"><FontAwesomeIcon icon={faSearch} /></Link>
                ...
                <div className="inline-block max-w-40 px-2">
                    <Link href="/list" className=" bg-red-500 rounded-full p-1 text-xl"><FontAwesomeIcon icon={faListUl} /></Link>
                ...
                <div className="inline-block max-w-40 px-2">
                    <Link href="/history" className=" bg-red-500 rounded-full p-1 text-xl"><FontAwesomeIcon icon={faClockRotateLeft} /></Link>
